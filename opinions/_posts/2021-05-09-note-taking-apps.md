---
title: "Second Brain: Note-taking apps"
...
| KEY FEATURES                                    | [Notion](https://www.notion.so/)                      | [Obsidian](https://obsidian.md/)                             | [Roam](https://roamresearch.com/)\*               | [Evernote](https://evernote.com/)                            | [RemNote](https://www.remnote.io/)             |
| ----------------------------------------------------- | ----------------------------------------------------- | ------------------------------------------------------------ | ---------------------------------------------------------- | ------------------------------------------------------------ | ---------------------------------------------- |
...
| Mobile App                                            | Android - Yes<br>iOS - Yes                            | No. Beta Testing                                             | Android - No<br>iOS - No                                   | Android - Yes<br>iOS - Yes                                   | Android - Yes<br>iOS - No                      |
| **Appearance**                                            |                                                       |                                                              |                                                            |                                                              |                                                |
| [WYSIWYG](https://en.wikipedia.org/wiki/WYSIWYG) view | Yes                                                   | Markdown Preview                                             | Yes                                                        | Yes                                                          | Yes                                            |
...
| Backlinks                                             | Bit clunky +<br>No Graph view                         | Very easy +<br>Graph view                                    | Very easy +<br>Graph view                                  | Not native                                                   | Graph view needs Pro plan                    |
...
| Top 2 things I like                                   | 1\. Tables<br>2\. Variety of options                  | 1\. Bi-directional linking<br>2\. Own and store data locally | 1\. Bi-directional linking<br>2\. Frictionless note-taking | 1\. Scan handwritten notes<br>2\. Simple to get started         | 1\. Flash cards<br>2\. High student focus      |
| Top 2 things I do not like                                | 1\. Page load time slow<br>2\. Limited offline access | 1\. No drag & drop interface<br>2\. Limited features         | 1\. Expensive<br>2\. No native windows app                 | 1\. Features and interface<br>2\. Limited free tier | 1\. Slow to load<br>2\. Steeper learning curve |
...
\**Roam Research does not have a free tier. Features listed are in the paid plan.*<br>
...
## Closing Thoughts
Let's invoke the [Pareto principle](https://en.wikipedia.org/wiki/Pareto_principle) here too. Clearly defining your use cases, workflow, and priorities is the 20% input that will yield 80% of the results.
